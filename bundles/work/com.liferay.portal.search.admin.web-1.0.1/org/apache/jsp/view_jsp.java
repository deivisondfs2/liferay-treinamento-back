...
portletURL.setParameter("mvcRenderCommandName", "/search_admin/view");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1ui_panel$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n");
            out.write("\t\t<div class=\"panel panel-default search-admin-tabs id=\"adminSearchInformationPanel\">\n");
            out.write("\t\t\t<div class=\"panel-body\">\n");
            out.write("\t\t\t\t");
            out.write("\n");
            out.write("\t\t\t\t\t");
if (
 !searchAdminDisplayContext.isMissingSearchEngine() ) {
            out.write("\n");
			...
			if (!reindexSingleBackgroundTasks.isEmpty()) {
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t<div class=\"index-action-wrapper pull-right\" data-type=\"portal\">\n");
              out.write("\t\t\t\t\t\t");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t");
if (
 (backgroundTaskDisplay == null) || !backgroundTaskDisplay.hasPercentage() ) {
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t");
              ...
              out.write("\t\t\t\t\t\t</div>\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t<div class=\"index-action-wrapper pull-right\" data-type=\"");
...
if (
 (backgroundTaskDisplay == null) || !backgroundTaskDisplay.hasPercentage() ) {
              ...
              _jspx_th_aui_button_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_0);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("fm,\n");
          out.write("\t\t\tindexActionsPanel: '#adminSearchAdminIndexActionsPanel',\n");
          out.write("\t\t\tnamespace: '");
