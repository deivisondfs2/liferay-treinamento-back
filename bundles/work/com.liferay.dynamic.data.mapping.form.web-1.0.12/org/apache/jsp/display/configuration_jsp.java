...
DDMFormInstance selFormInstance = DDMFormInstanceServiceUtil.fetchFormInstance(formInstanceId);
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.print( (selFormInstance != null) ? HtmlUtil.unescape(selFormInstance.getName(locale)) : StringPool.BLANK );
        out.write("</span>\n");
        out.write("\t\t\t\t</span>\n");
        out.write("\t\t\t</div>\n");
        out.write("\n");
          ...
          if (_jspx_eval_liferay$1ui_search$1container_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_liferay$1ui_search$1container$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                _jspx_th_liferay$1ui_search$1container$1column$1text_0.setValue( HtmlUtil.unescape(formInstance.getName(locale)) );
  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\n");
        out.write("\t\t\tif (displayFormInstanceId) {\n");
        out.write("\t\t\t\tvar domParser = new DOMParser();\n");
        out.write("\n");
        out.write("\t\t\t\tvar htmlDocument = domParser.parseFromString(formInstanceName, \"text/html\");\n");
        out.write("\n");
        out.write("\t\t\t\tvar unescapedFormInstanceName = htmlDocument.documentElement.textContent;\n");
        out.write("\n");
        out.write("\t\t\t\tdisplayFormInstanceId.set('innerHTML', unescapedFormInstanceName + ' (");
