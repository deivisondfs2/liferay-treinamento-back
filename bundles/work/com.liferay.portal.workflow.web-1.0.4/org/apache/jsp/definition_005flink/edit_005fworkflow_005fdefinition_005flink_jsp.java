...
String resource = workflowDefinitionLinkSearchEntry.getResource();
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        _jspx_th_aui_input_1.setValue( workflowDefinitionLinkDisplayContext.getGroupId() );
        ...
        _jspx_th_aui_input_2.setName("resource");
        _jspx_th_aui_input_2.setType("hidden");
        _jspx_th_aui_input_2.setValue( resource );
        ...
        _jspx_th_aui_select_0.setCssClass("workflow-definition-form");
        ...
        if (_jspx_eval_aui_select_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            _jspx_th_aui_option_1.setSelected( workflowDefinitionLinkDisplayContext.isWorkflowDefinitionSelected(workflowDefinition, className) );
            _jspx_th_aui_option_1.setValue( workflowDefinitionLinkDisplayContext.getWorkflowDefinitionValue(workflowDefinition) );
