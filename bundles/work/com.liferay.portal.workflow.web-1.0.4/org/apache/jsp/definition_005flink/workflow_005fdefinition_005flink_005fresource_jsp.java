...
String resource = workflowDefinitionLinkSearchEntry.getResource();
      ...
      out.write('	');
if (
 resourceTooltips.containsKey(classname) ) {
      out.write("\n");
      out.write("\t\t<div class=\"workflow-definition-link-resource\">\n");
      out.write("\t\t\t<span id=\"");
      ...
      out.print( resource );
      out.write("\n");
      out.write("\t\t\t\t<div class=\"clay-tooltip-right tooltip\" id=\"");
      out.print( randomNamespace );
      out.write("tooltip\" role=\"tooltip\">\n");
      out.write("\t\t\t\t\t<div class=\"arrow\"></div>\n");
      out.write("\t\t\t\t\t<div class=\"tooltip-inner\">\n");
      out.write("\t\t\t\t\t\t<div>");
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\tvar tooltip = document.getElementById('");
          out.print( randomNamespace );
          out.write("tooltip');\n");
          out.write("\n");
          out.write("\tvar resourceTooltip = document.getElementById('");
          out.print( randomNamespace );
          out.write("resourceTooltip');\n");
          out.write("\n");
          out.write("\tif (resourceTooltip) {\n");
          out.write("\t\tresourceTooltip.addEventListener(\n");
          out.write("\t\t\t'mouseover',\n");
          out.write("\t\t\tfunction() {\n");
          out.write("\t\t\t\tdom.toggleClasses(tooltip,'show');\n");
          out.write("\t\t\t});\n");
          out.write("\n");
          out.write("\t\tresourceTooltip.addEventListener(\n");
          out.write("\t\t\t'mouseout',\n");
