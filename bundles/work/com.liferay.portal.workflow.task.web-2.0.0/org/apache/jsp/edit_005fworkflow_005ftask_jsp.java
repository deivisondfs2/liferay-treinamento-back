            ...
            if (_jspx_eval_aui_col_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_aui_field$1wrapper_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                if (_jspx_eval_aui_fieldset_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                  ...
                  out.write("\t\t\t\t\t\t\t\t\t");
if (
 workflowTask.isAssignedToSingleUser() ) {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-col-field\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"list-group-card-icon\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
                  ...
                  _jspx_th_liferay$1ui_user$1portrait_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_1);
                  ...
                  out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"lfr-asset-assigned\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
                  ...
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-col-content card-col-gutters lfr-asset-assigned\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"lfr-asset-assigned\">\n");
                  out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
            ...
            out.write("\t\t\t\t");
if (
 Validator.isNotNull(workflowTask.getDescription()) ) {
            out.write("\n");
            out.write("\t\t\t\t\t");
            //  aui:col
            ...
            _jspx_th_aui_col_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
...
if (
 assetRenderer != null ) {
              ...
              if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                out.write("\t\t\t\t\t\t</div>\n");
                out.write("\n");
                out.write("\t\t\t\t\t\t<div class=\"task-content-actions\">\n");
                out.write("\t\t\t\t\t\t\t");
...
if (
 assetRenderer.hasViewPermission(permissionChecker) ) {
                    ...
                    _jspx_th_portlet_renderURL_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1list_0);
...
if (
 assetEntry != null ) {
                    ...
                    _jspx_th_liferay$1frontend_management$1bar$1button_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1list_0);
                    ...
                    out.write("\t\t\t\t\t\t\t\t\t");
if (
 workflowTaskDisplayContext.hasViewDiffsPortletURL(workflowTask) ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t");
                    //  liferay-ui:icon
                    ...
                    out.write("\t\t\t\t\t\t\t\t");
if (
 workflowTaskDisplayContext.hasEditPortletURL(workflowTask) ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t");
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t");
if (
 assetRenderer.hasEditPermission(permissionChecker) && workflowTaskDisplayContext.isShowEditURL(workflowTask) ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t");
                    //  liferay-frontend:management-bar-button
                    ...
                    _jspx_th_liferay$1frontend_management$1bar$1button_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1list_0);
 ...
 assetRenderer.hasEditPermission(permissionChecker) && !workflowTaskDisplayContext.isShowEditURL(workflowTask) && !workflowTask.isCompleted() ) {
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t\t");
                    if (_jspx_meth_liferay$1frontend_management$1bar$1button_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1ui_icon$1list_0, _jspx_page_context))
                      return;
                    out.write("\n");
                    out.write("\t\t\t\t\t\t\t\t\t\t");
                    out.write("\n");
                ...
                out.write("\t\t\t\t\t\t</div>\n");
                out.write("\n");
                out.write("\t\t\t\t\t\t<h3 class=\"task-content-title\">\n");
                out.write("\t\t\t\t\t\t\t");
                //  liferay-ui:icon
              ...
              if (_jspx_eval_liferay$1ui_panel_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                out.write("\n");
                out.write("\n");
                out.write("<div class=\"task-activity\">\n");
			...
			for (WorkflowLog workflowLog : workflowLogs) {
                ...
                out.write("\t\t\t\t\t\t\t\t");
if (
 workflowLog.getType() == WorkflowLog.TASK_COMPLETION ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t");
                //  liferay-ui:message
 ...
 workflowLog.getType() == WorkflowLog.TASK_UPDATE ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t");
                //  liferay-ui:message
                ...
                _jspx_th_liferay$1ui_message_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
 ...
 workflowLog.getType() == WorkflowLog.TRANSITION ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t");
                //  liferay-ui:message
                ...
                _jspx_th_liferay$1ui_message_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
 ...
 workflowTaskDisplayContext.isAuditUser(workflowLog) ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t");
                //  liferay-ui:message
                ...
                _jspx_th_liferay$1ui_message_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
 ...
 workflowLog.getRoleId() == 0 ) {
                ...
                _jspx_th_liferay$1ui_message_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
                ...
                out.write("\t\t\t\t\t\t\t\t\t");
if (
 workflowLog.getPreviousUserId() != 0 ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t\t");
                //  liferay-ui:message
                ...
                _jspx_th_liferay$1ui_message_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
                ...
                _jspx_th_liferay$1ui_message_8.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_panel_2);
  ...
  private boolean _jspx_meth_liferay$1frontend_management$1bar$1button_2(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1ui_icon$1list_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-frontend:management-bar-button
    ...
    _jspx_th_liferay$1frontend_management$1bar$1button_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1ui_icon$1list_0);
