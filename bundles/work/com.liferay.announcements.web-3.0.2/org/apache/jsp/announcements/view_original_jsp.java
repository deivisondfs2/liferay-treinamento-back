...
public final class view_original_jsp extends org.apache.jasper.runtime.HttpJspBase
...
portletURL.setParameter("tabs1", announcementsRequestHelper.getTabs1());
      ...
      out.write('\n');
if (
 announcementsDisplayContext.isTabs1Visible() ) {
      out.write('\n');
      out.write('	');
      //  liferay-ui:tabs
      ...
      out.write('\n');
if (
 PortletPermissionUtil.hasControlPanelAccessPermission(permissionChecker, scopeGroupId, AnnouncementsPortletKeys.ANNOUNCEMENTS_ADMIN) ) {
      out.write("\n");
	...
	renderRequest.setAttribute(WebKeys.PORTLET_CONFIGURATOR_VISIBILITY, Boolean.TRUE);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t'/announcementsflag/add-flag',\n");
          out.write("\t\t\t{\n");
          out.write("\t\t\t\tentryId: entryId,\n");
          out.write("\t\t\t\tvalue: ");
          out.print( AnnouncementsFlagConstants.HIDDEN );
          out.write("\n");
          out.write("\t\t\t},\n");
          out.write("\t\t\tAUI.$.proxy(Liferay.Portlet, 'refresh', '#p_p_id");
          ...
          out.write("\t\tLiferay.Service(\n");
          out.write("\t\t\t'/announcementsflag/get-flag',\n");
          out.write("\t\t\t\t{\n");
          out.write("\t\t\t\t\tentryId : entryId,\n");
          out.write("\t\t\t\t\tvalue: ");
          out.print( AnnouncementsFlagConstants.HIDDEN );
          ...
          out.write("\t\t\t\t\tLiferay.Service(\n");
          out.write("\t\t\t\t\t\t'/announcementsflag/delete-flag',\n");
          out.write("\t\t\t\t\t\t{\n");
          out.write("\t\t\t\t\t\t\tflagId: response.flagId\n");
          out.write("\t\t\t\t\t\t},\n");
          out.write("\t\t\t\t\t\tAUI.$.proxy(Liferay.Portlet, 'refresh', '#p_p_id");
