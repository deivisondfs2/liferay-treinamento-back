...
String fieldsJSONArrayString = fieldsJSONArray.toString();
            ...
            if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                out.write("') {\n");
                out.write("\t\t\thiddenAttributes = AUI._.without(hiddenAttributes, 'readOnly');\n");
                out.write("\t\t}\n");
                out.write("\n");
                ...
                out.write("\n");
                out.write("\t\tvar setFieldsHiddenAttributes = _.bindKey(window, '");
                if (_jspx_meth_portlet_namespace_11((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_1, _jspx_page_context))
                  return;
                out.write("setFieldsHiddenAttributes', formBuilder, mode);\n");
                out.write("\n");
                out.write("\t\t_.forEach(formBuilder.get('fields')._items, setFieldsHiddenAttributes);\n");
                out.write("\n");
                out.write("\t\t_.forEach(formBuilder.get('availableFields'), setFieldsHiddenAttributes);\n");
                out.write("\n");
