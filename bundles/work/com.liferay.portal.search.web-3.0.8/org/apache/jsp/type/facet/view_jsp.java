...
AssetEntriesSearchFacetDisplayContext assetEntriesSearchFacetDisplayContext = (AssetEntriesSearchFacetDisplayContext)java.util.Objects.requireNonNull(request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT));
      ...
      out.write('	');
if (
 assetEntriesSearchFacetDisplayContext.isRenderNothing() ) {
      out.write("\n");
      out.write("\t\t");
      //  aui:input
          ...
          if (_jspx_eval_liferay$1ui_panel_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_aui_fieldset_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                out.write("\n");
                out.write("\t\t\t\t\t\t<ul class=\"asset-type list-unstyled\">\n");
                out.write("\n");
                out.write("\t\t\t\t\t\t\t");
                ...
                out.print( i );
                out.write("\">\n");
                out.write("\t\t\t\t\t\t\t\t\t\t<input class=\"facet-term\" data-term-id=\"");
                ...
                out.write("\t\t\t\t\t\t\t\t\t\t");
if (
 assetEntriesSearchFacetTermDisplayContext.isFrequencyVisible() ) {
                out.write("\n");
              ...
              out.write("\t\t\t\t\t");
if (
 !assetEntriesSearchFacetDisplayContext.isNothingSelected() ) {
              out.write("\n");
              out.write("\t\t\t\t\t\t<a class=\"text-default\" href=\"javascript:;\" onClick=\"Liferay.Search.FacetUtil.clearSelections(event);\"><small>");
