...
com.liferay.portal.kernel.dao.search.SearchContainer<com.liferay.portal.kernel.search.Document> searchContainer1 = searchResultsPortletDisplayContext.getSearchContainer();
      ...
      out.write("\n");
      out.write("<style>\n");
      out.write("\t.taglib-asset-tags-summary a.badge, .taglib-asset-tags-summary a.badge:hover {\n");
      out.write("\t\tcolor: #65B6F0;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\t.search-total-label {\n");
      out.write("\t\tmargin-top: 35px;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\t.search-asset-type-sticker {\n");
      out.write("\t\tcolor: #869CAD;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\t.search-document-content {\n");
      out.write("\t\tfont-weight: 400;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\t.search-result-thumbnail-img {\n");
      out.write("\t\theight: 44px;\n");
      out.write("\t\twidth: 44px;\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\t.tabular-list-group .list-group-item-content h6.search-document-tags {\n");
      out.write("\t\tmargin-top: 13px;\n");
      out.write("\t}\n");
      out.write("</style>\n");
      out.write("\n");
      out.write("<p class=\"search-total-label text-default\">\n");
      out.write("\t");
...
if (
 searchResultSummaryDisplayContext.isUserPortraitVisible() ) {
                ...
                out.write("\t\t\t\t\t");
if (
 searchResultSummaryDisplayContext.isThumbnailVisible() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t<img alt=\"blog cover image\" class=\"img-rounded search-result-thumbnail-img\" src=\"");
                ...
                out.write("\t\t\t\t\t");
if (
 searchResultSummaryDisplayContext.isIconVisible() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t<span class=\"search-asset-type-sticker sticker sticker-rounded sticker-secondary sticker-static\">\n");
...
if (
 searchResultSummaryDisplayContext.isLocaleReminderVisible() ) {
                ...
                out.write("\t\t\t\t\t\t");
if (
 searchResultSummaryDisplayContext.isCreatorVisible() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t\t");
...
if (
 searchResultSummaryDisplayContext.isContentVisible() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t<h6 class=\"search-document-content text-default\">\n");
                out.write("\t\t\t\t\t\t\t");
...
if (
 searchResultSummaryDisplayContext.isAssetCategoriesOrTagsVisible() ) {
                out.write("\n");
                out.write("\t\t\t\t\t\t<h6 class=\"search-document-tags text-default\">\n");
                out.write("\t\t\t\t\t\t\t");
...
if (
 searchResultSummaryDisplayContext.isDocumentFormVisible() ) {
                ...
                out.write("\n");
                out.write("\t\t\t\t\t\t\t\t\t\t<tr>\n");
                out.write("\t\t\t\t\t\t\t\t\t\t\t<td style=\"word-break:break-all;\" width=\"25%\">\n");
                out.write("\t\t\t\t\t\t\t\t\t\t\t\t<strong>");
