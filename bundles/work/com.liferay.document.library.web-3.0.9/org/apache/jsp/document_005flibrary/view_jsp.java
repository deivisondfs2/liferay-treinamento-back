...
request.setAttribute("view.jsp-displayStyle", displayStyle);
	...
	boolean portletTitleBasedNavigation = GetterUtil.getBoolean(portletConfig.getInitParameter("portlet-title-based-navigation"));
      ...
      out.write("\t\t\t\t");
if (
 !mvcRenderCommandName.equals("/document_library/search") ) {
      out.write("\n");
      out.write("\t\t\t\t\t");
      //  liferay-util:include
      ...
      out.write("\t\t\t");
if (
 portletDisplay.isWebDAVEnabled() && BrowserSnifferUtil.isIeOnWin32(request) ) {
      out.write("\n");
      ...
      if (_jspx_eval_aui_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        out.write("\n");
        out.write("\n");
        out.write("\t\t\t\t<div class=\"document-container\">\n");
        out.write("\t\t\t\t\t");
        out.write("\n");
        out.write("\t\t\t\t\t\t");
if (
 mvcRenderCommandName.equals("/document_library/search") ) {
	...
	String thumbnailSrc = themeDisplay.getPathThemeImages() + "/file_system/large/default.png";
        ...
        out.write("\n");
        out.write("\n");
        out.write("\t<li class=\"display-descriptive entry-display-style list-group-item\">\n");
        out.write("\t\t<div class=\"list-group-item-field\"></div>\n");
        out.write("\n");
        out.write("\t\t<div class=\"list-group-item-field\">\n");
        out.write("\t\t\t<div class=\"click-selector user-icon user-icon-square user-icon-xl\">\n");
...
if (!DLFolderPermission.contains(permissionChecker, scopeGroupId, folderId, ActionKeys.ADD_DOCUMENT)) {
	...
	if (!assetVocabularies.isEmpty()) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("fm2);\n");
          out.write("\n");
          out.write("\t\tvar hide = Liferay.Util.listCheckedExcept(form, '");
	...
	for (int i = 0; i < entryColumns.length; i++) {
		escapedEntryColumns[i] = HtmlUtil.escapeJS(entryColumns[i]);
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar clearDocumentLibraryHandles = function(event) {\n");
          out.write("\t\tif (event.portletId === '");
          out.print( portletDisplay.getId() );
          out.write("') {\n");
          out.write("\t\t\tdocumentLibrary.destroy();\n");
          out.write("\n");
          out.write("\t\t\tLiferay.detach('destroyPortlet', clearDocumentLibraryHandles);\n");
          out.write("\t\t}\n");
          out.write("\t};\n");
          out.write("\n");
          out.write("\tLiferay.on('destroyPortlet', clearDocumentLibraryHandles);\n");
          out.write("\n");
  ...
  private boolean _jspx_meth_portlet_param_11(javax.servlet.jsp.tagext.JspTag _jspx_th_portlet_renderURL_1, PageContext _jspx_page_context)
    ...
    _jspx_th_portlet_param_11.setValue("/document_library/view_file_entry");
