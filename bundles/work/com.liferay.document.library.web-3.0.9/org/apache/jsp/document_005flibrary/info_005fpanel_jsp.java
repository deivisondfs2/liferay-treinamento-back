...
if (ListUtil.isEmpty(folders) && ListUtil.isEmpty(fileEntries) && ListUtil.isEmpty(fileShortcuts)) {
	...
	if (folder != null) {
      ...
      out.write('	');
if (
 ListUtil.isEmpty(fileEntries) && ListUtil.isEmpty(fileShortcuts) && ListUtil.isNotEmpty(folders) && (folders.size() == 1) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
      ...
      out.write("\t\t\t<ul class=\"sidebar-actions\">\n");
      out.write("\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\t\t\t</ul>\n");
      out.write("\n");
      out.write("\t\t\t<h4 class=\"sidebar-title\">");
      out.print( (folder != null) ? folder.getName() : LanguageUtil.get(request, "home") );
      out.write("</h4>\n");
      out.write("\n");
      out.write("\t\t\t<h5 class=\"sidebar-subtitle\">\n");
      out.write("\t\t\t\t");
      ...
      if (_jspx_eval_liferay$1ui_tabs_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1ui_section_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t\t\t\t<dl class=\"sidebar-block\">\n");
...
if (
 ...
 ListUtil.isEmpty(folders) && ListUtil.isEmpty(fileShortcuts) && ListUtil.isNotEmpty(fileEntries) && (fileEntries.size() == 1) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
 ...
 ListUtil.isEmpty(folders) && ListUtil.isEmpty(fileEntries) && ListUtil.isNotEmpty(fileShortcuts) && (fileShortcuts.size() == 1) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t\t");
