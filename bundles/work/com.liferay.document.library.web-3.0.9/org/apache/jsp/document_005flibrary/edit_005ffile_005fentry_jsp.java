...
if (portletTitleBasedNavigation) {
	...
	renderResponse.setTitle(headerTitle);
      ...
      out.write('\n');
if (
 portletTitleBasedNavigation && (fileVersion != null) ) {
      out.write("\n");
      out.write("\n");
      out.write("\t");
...
if (
 lock.isNeverExpires() ) {
      ...
      out.write("\t");
if (
 !portletTitleBasedNavigation && showHeader ) {
      out.write("\n");
      out.write("\t\t");
      //  liferay-ui:header
...
if (
 fileMaxSize != 0 ) {
            ...
            out.write("\t\t\t\t\t\t");
if (
 dlEditFileEntryDisplayContext.isFolderSelectionVisible() ) {
            out.write("\n");
            out.write("\t\t\t\t\t\t\t");
            //  aui:input
            ...
            if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                ...
                out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tidString: 'folderId',\n");
                out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tidValue: event.folderid,\n");
                out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tnameString: 'folderName',\n");
...
if (
 dlFilePicker == null ) {
            ...
            if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                out.write("\n");
                out.write("\t\t\tvar onFilePick = function(fields) {\n");
                out.write("\t\t\t\tvar documentIconURL = fields['");
                ...
                out.write("\n");
                out.write("\t\t\t\tvar documentTitle = fields['");
                ...
                out.write("\n");
                out.write("\t\t\t\tvar documentDescription = fields['");
                ...
                out.write("\t\t\t\t\t\titem = $(item);\n");
                out.write("\n");
                out.write("\t\t\t\t\t\tvar fieldName = item.data('fieldname');\n");
                out.write("\t\t\t\t\t\tvar input = item.find('input');\n");
                out.write("\n");
                out.write("\t\t\t\t\t\tinput.val(fields[fieldName]);\n");
                out.write("\t\t\t\t\t}\n");
                out.write("\t\t\t\t);\n");
                out.write("\t\t\t};\n");
                out.write("\n");
                ...
                out.write("\n");
                out.write("\n");
                out.write("\t\t\tvar filePicker = new ");
                out.print( dlFilePicker.getJavaScriptModuleName() );
                out.write("(\n");
                out.write("\t\t\t\tfunction() {\n");
                out.write("\t\t\t\t\tLiferay.Util.toggleDisabled($('.customized-file-button'), false);\n");
                out.write("\t\t\t\t}\n");
                out.write("\t\t\t);\n");
                out.write("\n");
                out.write("\t\t\t$('.customized-file-button').on('click', _.bind(filePicker['");
            ...
            out.write("\t\t\t\t\t");
if (
 (folder == null) || folder.isSupportsMetadata() ) {
            out.write("\n");
            out.write("\t\t\t\t\t\t");
...
if (
 (folder == null) || (folder.getModel() instanceof DLFolder) ) {
            ...
            out.write("\t\t\t\t\t\t\t\t");
if (
 !cmd.equals(Constants.ADD) && (dlFileEntryTypes.size() > 1) ) {
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t");
            //  aui:select
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t");
if (
 !dlEditFileEntryDisplayContext.isDDMStructureVisible(ddmStructure) ) {
            out.write("\n");
...
if (
 (folder == null) || folder.isSupportsMetadata() ) {
          ...
          out.write("\t\t\t\t");
if (
 (folder == null) || folder.isSupportsSocial() ) {
          out.write("\n");
          out.write("\t\t\t\t\t");
          //  aui:fieldset
          ...
          out.write("\t\t\t\t");
if (
 (fileEntry == null) && dlEditFileEntryDisplayContext.isPermissionsVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t\t");
          //  aui:fieldset
...
if (
 pending ) {
          ...
          out.write("\t\t\t\t\t<div class=\"alert alert-info\">\n");
          out.write("\t\t\t\t\t\t");
          if (_jspx_meth_liferay$1ui_message_12((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset$1group_0, _jspx_page_context))
            return;
          out.write("\n");
          out.write("\t\t\t\t\t</div>\n");
          out.write("\t\t\t\t");
        ...
        if (_jspx_eval_aui_button$1row_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          out.write("\t\t\t");
if (
 dlEditFileEntryDisplayContext.isSaveButtonVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  aui:button
          ...
          out.write("\t\t\t");
if (
 dlEditFileEntryDisplayContext.isPublishButtonVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  aui:button
          ...
          out.write("\t\t\t");
if (
 dlEditFileEntryDisplayContext.isCheckoutDocumentButtonVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  aui:button
          ...
          _jspx_th_aui_button_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_button$1row_0);
          ...
          out.write("\t\t\t");
if (
 dlEditFileEntryDisplayContext.isCheckinButtonVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  aui:button
          ...
          _jspx_th_aui_button_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_button$1row_0);
          ...
          out.write("\t\t\t");
if (
 dlEditFileEntryDisplayContext.isCancelCheckoutDocumentButtonVisible() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  aui:button
          ...
          _jspx_th_aui_button_7.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_button$1row_0);
	...
	request.setAttribute("edit_file_entry.jsp-checkedOut", checkedOut);
      ...
      if (_jspx_eval_aui_script_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("fm);\n");
          out.write("\n");
          out.write("\t\tvar fileValue = form.fm('file').val();\n");
          out.write("\n");
          out.write("\t\tif (fileValue) {\n");
          out.write("\t\t\t");
          ...
          out.write("\t\t\tLiferay.Portlet.DocumentLibrary.Checkin.showDialog(\n");
          out.write("\t\t\t\t'");
          ...
          if (_jspx_meth_liferay$1ui_message_13((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_2, _jspx_page_context))
            return;
          out.write("',\n");
          out.write("\t\t\t\t\tcallback: function(event) {\n");
          out.write("\t\t\t\t\t\tvar $ = AUI.$;\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tvar majorVersionNode = $('input:radio[name=\"");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\tform.fm('majorVersion').val(majorVersionNode.val());\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tvar changeLogNode = $('#");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\tform.fm('changeLog').val(changeLogNode.val());\n");
          out.write("\n");
          out.write("\t\t\t\t\t\tsubmitForm(form);\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t},\n");
          ...
          out.write("\t\t\t);\n");
          out.write("\t\t},\n");
          out.write("\t\t['document-library-checkin']\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tfunction ");
          ...
          out.write("file').val();\n");
          out.write("\n");
          out.write("\t\t\tvar fileName = filePath.replace(/^.*[\\\\\\/]/, '');\n");
          out.write("\n");
          out.write("\t\t\t$('#");
...
if (fileEntry != null) {
  ...
  private boolean _jspx_meth_liferay$1ui_message_12(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset$1group_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_12.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset$1group_0);
