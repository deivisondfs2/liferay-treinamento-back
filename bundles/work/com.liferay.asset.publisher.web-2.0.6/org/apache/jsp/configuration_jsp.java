	...
	request.setAttribute("configuration.jsp-redirect", redirect);
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("fm);\n");
          out.write("\n");
          out.write("\t\tform.fm('classNameIds').val(Util.listSelect(form.fm('currentClassNameIds')));\n");
          out.write("\n");
          out.write("\t\t");
		...
		for (AssetRendererFactory<?> curRendererFactory : classTypesAssetRendererFactories) {
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\tform.fm('classTypeIds");
          out.print( className );
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\tform.fm('metadataFields').val(Util.listSelect(form.fm('currentMetadataFields')));\n");
          out.write("\n");
