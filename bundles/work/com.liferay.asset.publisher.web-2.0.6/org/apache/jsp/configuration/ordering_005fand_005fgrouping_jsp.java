  ...
  private boolean _jspx_meth_aui_script_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\n");
        out.write("\t\t\tvar orderByTypeContainer = currentTarget.ancestor('.order-by-type-container');\n");
        out.write("\n");
        out.write("\t\t\torderByTypeContainer.all('.icon').toggleClass('hide');\n");
        out.write("\n");
        out.write("\t\t\tvar orderByTypeField = orderByTypeContainer.one('.order-by-type-field');\n");
        out.write("\n");
        out.write("\t\t\tvar newVal = orderByTypeField.val() === 'ASC' ? 'DESC' : 'ASC';\n");
        out.write("\n");
        out.write("\t\t\torderByTypeField.val(newVal);\n");
        out.write("\t\t},\n");
        out.write("\t\t'.icon'\n");
        out.write("\t);\n");
