...
if (
 Validator.isNotNull(assetPublisherDisplayContext.getDDMStructureFieldLabel()) && (classNameIds[0] == PortalUtil.getClassNameId(assetRendererFactory.getClassName())) ) {
        ...
        if (_jspx_meth_portlet_namespace_5((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_fieldset_0, _jspx_page_context))
          return;
 ...
 assetPublisherDisplayContext.isShowSubtypeFieldsFilter() ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\n");
          out.write("\tvar MAP_DDM_STRUCTURES = {};\n");
          out.write("\n");
          out.write("\tvar assetMultipleSelector = $('#");
          ...
          out.write("\tvar ddmStructureFieldName = $('#");
          ...
          out.write("\tvar sourcePanel = $('.source-container');\n");
          out.write("\n");
          out.write("\t");
	...
	for (AssetRendererFactory<?> curRendererFactory : classTypesAssetRendererFactories) {
		String className = assetPublisherWebUtil.getClassName(curRendererFactory);
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\tUtil.toggleSelectBox('");
          ...
          out.write("\t\t\tvar assetOptions = assetMultipleSelector.find('option');\n");
          out.write("\n");
          out.write("\t\t\tvar showOptions = ((assetSelector.val() == '");
          out.print( curRendererFactory.getClassNameId() );
          out.write("') ||\n");
          out.write("\t\t\t\t((assetSelector.val() == 'false') && (assetOptions.length == 1) && (assetOptions.eq(0).val() == '");
          out.print( curRendererFactory.getClassNameId() );
          out.write("')));\n");
          out.write("\n");
          out.write("\t\t\t");
          ...
          out.write("\n");
          out.write("\t\t\tif (removeOrderBySubtype) {\n");
          out.write("\t\t\t\torderByColumn1.find('.order-by-subtype').remove();\n");
          out.write("\t\t\t\torderByColumn2.find('.order-by-subtype').remove();\n");
          out.write("\t\t\t}\n");
          out.write("\n");
          out.write("\t\t\t");
if (
 assetPublisherDisplayContext.isShowSubtypeFieldsFilter() ) {
		...
		for (ClassType classType : assetAvailableClassTypes) {
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\tvar optgroupClose = '</optgroup>';\n");
          out.write("\t\t\tvar optgroupOpen = '<optgroup class=\"order-by-subtype\" label=\"");
          out.print( HtmlUtil.escape(classType.getName()) );
          out.write("\">';\n");
          out.write("\n");
          out.write("\t\t\tvar columnBuffer1 = [optgroupOpen];\n");
          out.write("\t\t\tvar columnBuffer2 = [optgroupOpen];\n");
          out.write("\n");
          out.write("\t\t\t");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\tcolumnBuffer1.push('<option ");
          ...
          out.write("</option>');\n");
          out.write("\t\t\t\tcolumnBuffer2.push('<option ");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\tcolumnBuffer1.push(optgroupClose);\n");
          out.write("\t\t\tcolumnBuffer2.push(optgroupClose);\n");
          out.write("\n");
          out.write("\t\t\tMAP_DDM_STRUCTURES['");
          out.print( className );
          out.write('_');
          out.print( classType.getClassTypeId() );
...
if (
 assetPublisherDisplayContext.isShowSubtypeFieldsFilter() ) {
          ...
          out.write("\t\t\t\tvar subtypeFieldsWrapper = $('#");
          ...
          out.write("subtypeFieldsFilterEnableWrapper');\n");
          out.write("\n");
          out.write("\t\t\t\tvar selectedSubtype = ");
          out.print( className );
          out.write("SubtypeSelector.val();\n");
          out.write("\n");
          out.write("\t\t\t\tvar structureOptions = $('#");
          ...
          out.write("Options');\n");
          out.write("\n");
          out.write("\t\t\t\tstructureOptions.removeClass('hide');\n");
          out.write("\n");
          out.write("\t\t\t\tif ((selectedSubtype != 'false') && (selectedSubtype != 'true')) {\n");
          out.write("\t\t\t\t\torderByColumn1.find('.order-by-subtype').remove();\n");
          out.write("\t\t\t\t\torderByColumn2.find('.order-by-subtype').remove();\n");
          out.write("\n");
          out.write("\t\t\t\t\torderByColumn1.append(MAP_DDM_STRUCTURES['");
          out.print( className );
          out.write("_' + selectedSubtype + '_optTextOrderByColumn1']);\n");
          out.write("\t\t\t\t\torderByColumn2.append(MAP_DDM_STRUCTURES['");
          out.print( className );
          out.write("_' + selectedSubtype + '_optTextOrderByColumn2']);\n");
          out.write("\n");
          out.write("\t\t\t\t\tif (structureOptions.length) {\n");
          out.write("\t\t\t\t\t\tsubtypeFieldsWrapper.removeClass('hide');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t\telse if (hideSubtypeFilterEnableWrapper) {\n");
          out.write("\t\t\t\t\t\tsubtypeFieldsWrapper.addClass('hide');\n");
          out.write("\t\t\t\t\t}\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t\telse if (hideSubtypeFilterEnableWrapper) {\n");
          out.write("\t\t\t\t\tsubtypeFieldsWrapper.addClass('hide');\n");
          ...
          out.write("\t\t\t\t\tsetDDMFields('");
          out.print( className );
          out.write("', '', '', '', '');\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar subtypeFieldsFilterEnabled = $('#");
          ...
          out.write("');\n");
          out.write("\n");
          out.write("\t\t\t\t\tsubtypeFieldsFilterEnabled.prop('checked', false);\n");
          out.write("\n");
          out.write("\t\t\t\t\tsourcePanel.find('.asset-subtypefields').addClass('hide');\n");
          out.write("\n");
          out.write("\t\t\t\t\t");
          out.print( className );
          out.write("toggleSubclassesFields(true);\n");
		...
		for (AssetRendererFactory<?> curRendererFactory : classTypesAssetRendererFactories) {
          ...
          out.write("\n");
          out.write("\tassetSelector.on(\n");
          out.write("\t\t'change',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tddmStructureFieldName.val('');\n");
          out.write("\n");
          out.write("\t\t\t$('#");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tsourcePanel.on(\n");
          out.write("\t\t'click',\n");
          out.write("\t\t'.asset-subtypefields-wrapper-enable label',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tvar assetSubtypeFieldsPopupNodes = $('.asset-subtypefields-popup .btn');\n");
          out.write("\n");
          out.write("\t\t\tUtil.toggleDisabled(assetSubtypeFieldsPopupNodes, !$(event.target).prop('checked'));\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tLiferay.after(\n");
          out.write("\t\t'inputmoveboxes:moveItem',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tif ((event.fromBox.attr('id') == '");
          ...
          out.write("\tsourcePanel.on(\n");
          out.write("\t\t'click',\n");
          out.write("\t\t'.asset-subtypefields-popup',\n");
          out.write("\t\tfunction(event) {\n");
          out.write("\t\t\tvar currentTarget = $(event.currentTarget);\n");
          out.write("\n");
          out.write("\t\t\tvar btn = $('.btn', currentTarget);\n");
          out.write("\n");
          out.write("\t\t\tvar uri = btn.data('href');\n");
          out.write("\n");
          out.write("\t\t\turi = Util.addParams('_");
          ...
          out.write("\t\t\t\t},\n");
          out.write("\t\t\t\tfunction(event) {\n");
          out.write("\t\t\t\t\tsetDDMFields(event.className, event.name, event.value, event.displayValue, event.label + ': ' + event.displayValue);\n");
          out.write("\t\t\t\t}\n");
          out.write("\t\t\t);\n");
          out.write("\t\t}\n");
          out.write("\t);\n");
          out.write("\n");
          out.write("\tfunction setDDMFields(className, name, value, displayValue, message) {\n");
          out.write("\t\t$('#");
  ...
  private boolean _jspx_meth_portlet_namespace_5(javax.servlet.jsp.tagext.JspTag _jspx_th_aui_fieldset_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  portlet:namespace
    ...
    _jspx_th_portlet_namespace_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
