...
PortletURL configurationRenderURL = (PortletURL)request.getAttribute("configuration.jsp-configurationRenderURL");
	...
	for (String paginationType : assetPublisherDisplayContext.PAGINATION_TYPES) {
      ...
      out.write('\n');
if (
 !assetPublisherWebConfiguration.searchWithIndex() ) {
      out.write('\n');
      out.write('	');
if (
 assetPublisherDisplayContext.isSelectionStyleDynamic() ) {
      ...
      if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("\tvar selectDisplayStyle = $('#");
          if (_jspx_meth_portlet_namespace_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_aui_script_0, _jspx_page_context))
            return;
          out.write("displayStyle');\n");
          out.write("\n");
          out.write("\tfunction showHiddenFields() {\n");
          out.write("\t\tvar hiddenFields = $('.hidden-field');\n");
          out.write("\n");
          out.write("\t\thiddenFields.parentsUntil('.general-display-settings', '.checkbox, .form-group').addClass('hide');\n");
          out.write("\n");
          out.write("\t\tvar displayStyle = selectDisplayStyle.val();\n");
          out.write("\n");
          out.write("\t\tif (displayStyle == 'full-content') {\n");
          out.write("\t\t\tshowParent('.show-asset-title');\n");
          out.write("\t\t\tshowParent('.show-context-link');\n");
          out.write("\t\t\tshowParent('.show-extra-info');\n");
          out.write("\t\t}\n");
          out.write("\t\telse if (displayStyle == 'abstracts') {\n");
          out.write("\t\t\tshowParent('.abstract-length');\n");
          out.write("\t\t}\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\tfunction showParent(child, parent) {\n");
          out.write("\t\t$(child).parentsUntil('.general-display-settings', '.form-group').removeClass('hide');\n");
          out.write("\t}\n");
          out.write("\n");
          out.write("\tshowHiddenFields();\n");
          out.write("\n");
          out.write("\tselectDisplayStyle.on('change', showHiddenFields);\n");
