...
public class AssignmentServiceHttp {
	...
	public static long getAssignmentsCountByKeywords(
		HttpPrincipal httpPrincipal, long groupId, String keywords, int status) {
		try {
			MethodKey methodKey = new MethodKey(AssignmentServiceUtil.class,
	...
	public static com.liferay.training.gradebook.model.Assignment updateAssignment(
		...
		try {
			MethodKey methodKey = new MethodKey(AssignmentServiceUtil.class,
					"updateAssignment", _updateAssignmentParameterTypes6);
	...
	private static final Class<?>[] _getAssignmentsByGroupIdParameterTypes3 = new Class[] {
			long.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getAssignmentsByKeywordsParameterTypes4 = new Class[] {
			long.class, String.class, int.class, int.class, int.class,
			com.liferay.portal.kernel.util.OrderByComparator.class
		};
	private static final Class<?>[] _getAssignmentsCountByKeywordsParameterTypes5 =
		new Class[] { long.class, String.class, int.class };
	private static final Class<?>[] _updateAssignmentParameterTypes6 = new Class[] {
			long.class, java.util.Map.class, String.class, java.util.Date.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
}