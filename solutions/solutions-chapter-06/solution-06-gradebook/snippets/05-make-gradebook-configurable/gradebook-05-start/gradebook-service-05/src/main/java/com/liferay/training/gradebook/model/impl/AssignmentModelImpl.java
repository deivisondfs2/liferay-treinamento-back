...
public class AssignmentModelImpl extends BaseModelImpl<Assignment>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(gradebook.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.training.gradebook.model.Assignment"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(gradebook.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.training.gradebook.model.Assignment"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(gradebook.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(gradebook.service.util.ServiceProps.get(
