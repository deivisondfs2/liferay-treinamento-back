...
/**
 * The implementation of the submission remote service. <p> All custom service
...
public class SubmissionServiceImpl extends SubmissionServiceBaseImpl {
	 ...
	 * {@link com.liferay.training.gradebook.service.SubmissionServiceUtil} to
	 * access the submission remote service.
	 */
	...
	public List<Submission> getSubmissionsByKeywords(
		...
		return submissionLocalService.getSubmissionsByKeywords(
	...
	public long getSubmissionsCountByKeywords(
		...
		return submissionLocalService.getSubmissionsCountByKeywords(
