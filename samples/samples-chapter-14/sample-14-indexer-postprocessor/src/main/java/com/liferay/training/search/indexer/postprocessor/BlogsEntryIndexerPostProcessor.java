 ...
 */
package com.liferay.training.search.indexer.postprocessor;
...
public class BlogsEntryIndexerPostProcessor implements IndexerPostProcessor {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlogsEntryIndexerPostProcessor.class);
